...
export default {
  ...
  data() {
    return {
      ...
      tasks: [
        {
          title: 'Task 1 : Desain Poster Event',
          description: 'Merancang poster promosi untuk sebuah event',
          isDone: false,
        },
        {
          title: 'Taks 2 : Rebranding Logo',
          description: 'Merancang ulang logo sesuai dengan prinsip desain grafis',
          isDone: false,
        },
        {
          title: 'Taks 3',
